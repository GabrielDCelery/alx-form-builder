window.alx_dynamic_form_config = {
    ...
    structure: {
        groups: [
            ...
            {
                "id": "criminal-record-declaration",
                "fields": [
            ...
            },
            {
                ...
                "fields": [
                    "id_field_do_you_want_to_opt_in_to_the_self_bill_agreement",
                    "id_field_olc_additional_information",
                    "id_field_olc_registration_pack_status",
                    "id_field_brand"
                ],
                "children": []
            }
    ...
    content: {
        page: {
            ...
            title: "Own Limited Company Contractor Registration Pack"
        },
        single: {
            fields: {
                "id_field_firstname": {
