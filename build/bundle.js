...
!function(factory) {
     true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(0), __webpack_require__(7), __webpack_require__(8) ], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
...
var DependencyInjector = __webpack_require__(16);

var QuickSelector = __webpack_require__(17);
...
$(document).ready(function () {
  ...
  var formPreparator = new FormPreparator();
  ...
  bugfix.init();
  var nativeMethodOverrides = new NativeMethodOverrides();
...
if(false) {
	module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/postcss-loader/lib/index.js??ref--3-2!../node_modules/sass-loader/lib/loader.js!./customstyle.scss", function() {
		var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/postcss-loader/lib/index.js??ref--3-2!../node_modules/sass-loader/lib/loader.js!./customstyle.scss");
...
function () {
  ...
  _createClass(DependencyInjector, [{
    key: "setTargetInstance",
    value: function setTargetInstance(_targetInstance) {
      this.targetInstance = _targetInstance;
      return this;
    }
  }, {
    key: "inject",
    value: function inject(_injectConfigs) {
      var _this = this;

      _injectConfigs.forEach(function (_injectConfig) {
        if (_this.targetInstance.hasOwnProperty(_injectConfig.key)) {
          throw new Error("Invalid dependency injection, key already exists -> ".concat(JSON.stringify(_injectConfig)));
        }

        return Object.defineProperty(_this.targetInstance, _injectConfig.key, {
...
function () {
  function QuickSelector() {
    _classCallCheck(this, QuickSelector);
  ...
  _createClass(QuickSelector, [{
    key: "_getElemFromCache",
    value: function _getElemFromCache(_strLabel, _strFieldId, _funcFindElem) {
      var _$cached = _.get(this.cached, [_strLabel, _strFieldId], null);

      if (_$cached) {
        return _$cached;
      }

      var _$elem = _funcFindElem(_strFieldId);
    ...
    key: "_getLabelOfField",
    value: function _getLabelOfField(_fieldSelector) {
      return this.$('label', this.getFieldWrapperDiv(_fieldSelector).prev());
    }
  }, {
    key: "_getLabelAndFieldWrapperDiv",
    value: function _getLabelAndFieldWrapperDiv(_fieldSelector) {
      return this.getFieldWrapperDiv(_fieldSelector).parent();
    }
  }, {
    key: "_getLabelWrapperDivOfField",
    value: function _getLabelWrapperDivOfField(_fieldSelector) {
      return this.getFieldWrapperDiv(_fieldSelector).prev();
    }
  }, {
    key: "_getFieldWrapperDiv",
    value: function _getFieldWrapperDiv(_fieldSelector) {
      var _$fieldWrapperDiv = this.$(_fieldSelector).parent();
...
/*#__PURE__*/
function () {
  function FormPreparator() {
    _classCallCheck(this, FormPreparator);
  ...
  _createClass(FormPreparator, [{
    ...
    value: function _decorateFieldWithHelperClasses(_fieldId) {
      var _fieldDecoratorClassess = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

      var _decoratorClassess = arguments.length > 2 ? arguments[2] : undefined;

      var _$field = this.QUICK_SELECTOR.getElemById(_fieldId);

      var _$fieldWrapper = this.QUICK_SELECTOR.getFieldWrapperDiv(_fieldId);

      var _$label = this.QUICK_SELECTOR.getLabelOfField(_fieldId);

      var _$labelWrapper = this.QUICK_SELECTOR.getLabelWrapperDivOfField(_fieldId);

      var _$labelAndFieldWrapper = this.QUICK_SELECTOR.getLabelAndFieldWrapperDiv(_fieldId);
    ...
    key: "_prepareFieldForNestedGrouping",
    value: function _prepareFieldForNestedGrouping(_fieldId, _groups) {
      var _this = this;
      ...
      var _$labelAndFieldWrapperDiv = this.QUICK_SELECTOR.getLabelAndFieldWrapperDiv(_fieldId);

      _groups.forEach(function (_group, _level) {
        if (!_this.nestedGroups[_level]) {
    ...
    key: "_editFieldLabel",
    value: function _editFieldLabel(_fieldId, _newLabel) {
      if (!_newLabel) {
        return;
      }
    ...
    key: "_editFieldPlaceholder",
    value: function _editFieldPlaceholder(_fieldId, _placeholder) {
      if (!_placeholder) {
        return;
      }
    ...
    value: function init(_config) {
      ...
      _config.fields.forEach(function (_fieldConfig) {
        ...
        _this3._prepareFieldForNestedGrouping(_fieldConfig.id, _fieldConfig.groups);

        _this3._editFieldLabel(_fieldConfig.id, _fieldConfig.label);

        _this3._editFieldPlaceholder(_fieldConfig.id, _fieldConfig.placeholder);
      });
...
function () {
  ...
  _createClass(FormDecorator, [{
    key: "_removeSubmitButton",
    value: function _removeSubmitButton() {
      this.$('#target_form_submit').remove();
    }
  }, {
    key: "_appendHeadingAndLogo",
    value: function _appendHeadingAndLogo(_config) {
      var _$heading = this.$('<heading/>');

      var _$logo = '<div id="logo"></div>';
...
var LOOKUP_ID_PREFIX = '_acl_';

var LookupFieldSynchronizer =
/*#__PURE__*/
function () {
  ...
  _createClass(LookupFieldSynchronizer, [{
    ...
    value: function _syncLookupField(_this, _arguments) {
      ...
      if (_arguments[0] !== undefined && _$field.attr('id') === this.primaryField) {
        ...
        return this.FORM_EVENTS.trigger(this.FORM_EVENTS.EVENT_SYNC_LOOKUP_FIELD, [{
          bValidateForm: false,
          fieldsToValidate: [this.primaryField, "".concat(this.PREFIX_LOOKUP_ID).concat(this.primaryField)]
        }]);
      }
    }
  }, {
    key: "init",
    value: function init(_lookupConfigs) {
  ...
  return LookupFieldSynchronizer;
}();
...
function () {
  ...
  _createClass(Paginator, [{
    ...
    value: function _initLocalEventListeners() {
      ...
      this.$(".".concat(LOCAL_DECORATOR_TRIGGER_MOVE_TO_PAGE)).off('click').on('click', function (_event) {
        _event.preventDefault();

        return _this2._moveToPage(_this2.$(_event.target).data(LOCAL_DATA_PAGE_ID));
      });
    }
  }, {
    ...
    value: function _traverseToNextValidPageId(_activePageIndex, _pointerTraverseMethod) {
      var _pointer = _activePageIndex;
    ...
    key: "_generateNavButton",
    value: function _generateNavButton(_label, _pageId, _customClasses, _$default) {
      if (_pageId == null) {
        if (_$default) {
          return _$default;
        }
    ...
    key: "_generatePreviousButton",
    value: function _generatePreviousButton() {
      var _validPageId = this._traverseToNextValidPageId(this._getActivePageIndex(), function (_val) {
        return _val - 1;
      });
    ...
    value: function _generateNextButton() {
      var _validPageId = this._traverseToNextValidPageId(this._getActivePageIndex(), function (_val) {
        return _val + 1;
      });
    ...
    key: "_moveToPage",
    value: function _moveToPage(_pageId) {
      if (_pageId) {
...
if(false) {
	module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/postcss-loader/lib/index.js??ref--3-2!../node_modules/sass-loader/lib/loader.js!./Paginator.scss", function() {
		var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/postcss-loader/lib/index.js??ref--3-2!../node_modules/sass-loader/lib/loader.js!./Paginator.scss");
...
// module
exports.push([module.i, ".alx-page {\n  opacity: 0;\n  height: 0;\n  overflow: hidden;\n  -webkit-transition: all 1s ease;\n  transition: all 1s ease; }\n  .alx-page.alx-page-active {\n    height: auto;\n    position: relative;\n    visibility: visible;\n    opacity: 1; }\n", ""]);
...
function () {
  ...
  _createClass(Validator, [{
    key: "_extendValidatiorPluginWithCustomValidators",
    value: function _extendValidatiorPluginWithCustomValidators() {
      this.$.validator.addMethod('pattern', function (_value, _elem, _params) {
        return new RegExp(_params).test(_value);
      }, 'Please enter a valid value in the correct format!');
    }
  }, {
    key: "_initValidatorPlugin",
    value: function _initValidatorPlugin() {
      this.QUICK_SELECTOR.getElemById(this.ID_FORM).validate({
        ignore: ".".concat(this.DECORATOR_STATE_IGNORE),
        success: function success(_label) {
    ...
    value: function _initGlobalEventListeners() {
      ...
      this.FORM_EVENTS.registerToFormEvent(this.FORM_EVENTS.EVENT_VALIDATE_FORM, function (_event, _bForSubmission) {
        _event.preventDefault();
    ...
    key: "_getErroredElements",
    value: function _getErroredElements() {
    ...
    key: "init",
    value: function init(_fieldValidatorConfigs, _lookupFields) {
      var _this3 = this;
      ...
      _.forEach(_fieldValidatorConfigs, function (_fieldValidatorConfig, _fieldId) {
        _this3._decorateFieldForValidation(_fieldId, _fieldValidatorConfig);

        if (_lookupFields.primary === _fieldId) {
          _this3.QUICK_SELECTOR.getElemById("".concat(_this3.PREFIX_LOOKUP_ID).concat(_fieldId)).addClass("".concat(_this3.DECORATOR_STATE_IGNORE));
        }
      });
...
function () {
  ...
  _createClass(FormEvents, [{
    key: "registerToFormEvent",
    value: function registerToFormEvent(_eventName, _methodToExecute) {
      this.QUICK_SELECTOR.getElemById(this.ID_FORM).on(_eventName, _methodToExecute);
    }
  }, {
    key: "trigger",
    value: function trigger(_formEventName, _variables) {
...
function () {
  ...
  _createClass(InputMask, [{
    ...
    value: function init(_config) {
      ...
      _.forEach(_config, function (_maskConfig, _fieldId) {
        var _fieldConfig = {
          onincomplete: _this._onInCompleteWrapper()
        };
        ...
        return new Inputmask(_fieldConfig).mask(_this.QUICK_SELECTOR.generateIdSelector(_fieldId));
      });
    }
  }, {
    key: "_onInCompleteWrapper",
    value: function _onInCompleteWrapper() {
      var _this2 = this;

      return function (_event) {
        return _this2.$(_event.target).val('');
      };
    }
  }]);
...
function () {
  ...
  _createClass(Bugfix, [{
    key: "_fixEnterTryingToSubmit",
    value: function _fixEnterTryingToSubmit() {
      var _this = this;

      this.QUICK_SELECTOR.getElemById(this.ID_FORM).keypress(function (_event) {
        if (_event.which == 13 && !_this.$(_event.target).is('textarea')) {
          return false;
        }
      });
    }
...
var NativeMethodOverrides =
/*#__PURE__*/
function () {
  function NativeMethodOverrides() {
    _classCallCheck(this, NativeMethodOverrides);
  }

  _createClass(NativeMethodOverrides, [{
    key: "_overrideJqueryVal",
    value: function _overrideJqueryVal() {
      var self = this;
      var _originalMethod = self.$.fn.val;

      self.$.fn.val = function () {
        var _returnValue = _originalMethod.apply(this, arguments);
