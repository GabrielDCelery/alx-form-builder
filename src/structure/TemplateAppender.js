...
const TEMPLATES = {
    default: require('./templates/default.json'),
    basic: require('./templates/basic.json')
};
...
class TemplateAppender {
    ...
    decorateMainWithClasses () {
        this._decorateElemsWithClasses(this.QUICK_SELECTOR.getElemById(this.DECORATOR_ID_MAIN), this.template.classes.page.main.main);
